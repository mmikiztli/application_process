class Mentor():
    ...
    def _1_list_mentors(cls):
        return [{"first_name": i.first_name, "last_name": i.last_name} for i in Mentor.get_all()]
    ...
    def _3_greatest_favourite_number(cls):
        return max(i.favourite_number for i in cls.get_all() if i.favourite_number != None)
